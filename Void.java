...
public class Void extends Main{
    //Deklarasi Variabel
    ...
    public Void(){ //constructor
        ...
        System.out.println("   Yuk Cari Tahu Tentang Hewan Peliharaanmu!");
        System.out.println(" ");
    }
    void kelompokhewan(){ //Method Pertama
        ...
        System.out.print("Masukkan Makanan Hewan [ Tumbuhan, Daging, Segala ] : "); //Input Makanan Hewan
        ...
        switch(makanan){ //Percabangan
            ...
            case "Daging"://jika makanan hewannya daging maka kelompok karnivora
                ...
                break;
            case "Segala": //jika makanan hewannya tumbuhan dan daging maka kelompok omnivora
